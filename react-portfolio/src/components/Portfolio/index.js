...
import DayPlanner from "./portfolio-pics/dayPlanner";
      ...
      <div className="col-sm-4 assignment1">
        <div className="card">
          <div className="card-body">
            ...
            <img src={Quiz} className="image-portfolio"></img>
      ...
      <div className="col-sm-4 game">
        <div className="card">
          <div className="card-body">
            ...
            <img src={Scratch} className="image-portfolio"></img>
      ...
      <div className="col-sm-4 placeholder1">
        <div className="card">
          <div className="card-body">
            ...
            <img src={Pack} className="image-portfolio"></img>
      ...
      <div className="col-sm-4 assignment1">
        <div className="card">
          <div className="card-body">
            ...
            <img src={DayPlanner} className="image-portfolio"></img>
      ...
      <div className="col-sm-4 game">
        <div className="card">
          <div className="card-body">
            ...
            <img src={Weather} className="image-portfolio"></img>
      ...
      <div className="col-sm-4 placeholder1">
        <div className="card">
          <div className="card-body">
            ...
            <img src={Nails} className="image-portfolio"></img>
